	...
	public VentanaEmpleado() {
		...
		btnInsertar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				listaEmpleados=FicheroEmpleado.lEmpleados;
				//Cargo el Empleado nuevo
				Empleado nuevoEmpleado=new Empleado(nif,nombre,
						                         correo,tfno,codigo);
				//Grabo el nuevo Empleado
		...
		txtCodigo.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(FocusEvent e) {
				if (!Validator.validarCodigoOperario(txtCodigo.getText()))
